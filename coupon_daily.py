...
# coding=utf-8
'''
@Date: 2019-08-20 11:56:43
@Author: YING
@LastEditTime: 2019-08-20 16:06:33
'''
...
def coupon_date(weekend_num=2):
    ...
    if day_of_week == 'Friday':
        ...
        start_date = dtnow + timediff
        start_date = start_date.strftime('%Y-%m-%d')
        
        # 周末天数，默认 2 天
        timediff = pd.Timedelta(weekend_num,unit='d')
        end_date = dtnow + timediff
        ...
        start_date = end_date = dt_ff.strftime('%Y-%m-%d')
...
def main():
    start_date,end_date = coupon_date(weekend_num=2)
    huikuan_str = 'https://cg.xiaojilicai.com/admin/borrow/repaymentplan?id=&borrow_id=&bond_id=&borrow_name=&plan_id=&plan_borrow_name=&borrow_duration=0&status=&borrow_status=&username=&realname=&cellphone=&min_money=&max_money=&market_source=&start_time2=&end_time2=&start_time=' + start_date + '&end_time=' + end_date + '&start_time3=&end_time3=&export=1&async=0&__hash__=7111ca15bd54dacc1ebb2f13436210e7_5367af9e996a9cf9753aaa7184890d12'
    weishiyong_str = 'https://cg.xiaojilicai.com/admin/coupon/publishcoupon?username=&realname=&cellphone=&company_name=&coupon_alias=&use_status=1&refer_id=&pack_name=&bill_id=&start_time=&end_time=&start_time2=&end_time2=&export=1&async=0&__hash__=e776bcc8348b125590c7d83c83cb054d_c884f04a16d4ae6d1fee5a9407ca9481'
    ...
    download_url = [huikuan_str,weishiyong_str,dangyuefafang_str]
